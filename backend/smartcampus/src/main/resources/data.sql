...
INSERT INTO users (
    id, oauth_provider, oauth_id, full_name, email, campus_id, password, created_at
) VALUES
...
INSERT INTO resource_type_skills (resource_type, skill_id) VALUES
('ACADEMIC', 1),
('ACADEMIC', 3),
('ACADEMIC', 4),
('LECTURE_HALL', 1),
...
INSERT INTO technician_skills (user_id, skill_id) VALUES
(30, 1),
(30, 2),
(40, 4),
(50, 3),
...
INSERT INTO resources (
    ...
    capacity, location, status, parent_id, created_at
) VALUES
...
INSERT INTO resource_faculties (resource_id, faculty) VALUES
(1, 'COMPUTING'),
(1, 'GRADUATE_STUDIES'),
...
INSERT INTO tickets (
    ...
    resolution_notes, rejected_reason, first_responded_at, resolved_at,
...
(1, 'Projector not turning on', 'Main Auditorium', 'EQUIPMENT',
 ...
 20, 30, 7, 2, DATE_ADD(NOW(), INTERVAL 4 HOUR), NULL,
 NULL, NULL, NULL, NULL,
...
(2, 'Electrical sparks near lab switchboard', 'Electrical Lab', 'SAFETY',
 ...
 70, 40, 15, 4, DATE_ADD(NOW(), INTERVAL 4 HOUR), NULL,
...
(3, 'Air conditioning not cooling', 'Architecture Studio', 'FACILITY',
 ...
 60, 50, 12, 3, DATE_ADD(NOW(), INTERVAL 1 DAY), NULL,
 NULL, NULL, NULL, NULL,
...
(4, 'Broken chairs in hall', 'Business Hall A', 'FURNITURE',
 ...
 20, 30, 13, 1, DATE_ADD(NOW(), INTERVAL 3 DAY), NULL,
 NULL, NULL, NULL, NULL,
 NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(5, 'Lab computers cannot access internet', 'Network Lab', 'NETWORK',
 ...
 'HIGH', 'ayesha@test.com', 'IN_PROGRESS',
 70, 30, 11, 2, DATE_ADD(NOW(), INTERVAL 4 HOUR), NULL,
 NULL, NULL, CURRENT_TIMESTAMP, NULL,
